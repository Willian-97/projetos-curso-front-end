...
const exprtBtn = document.querySelector("#export-notes");
...
function createNote(id, content,fixed) {
    ...
    const doplicateIcon = document.createElement("i");
    doplicateIcon.classList.add(...["bi", "bi-file-earmark-plus"]);
    element.appendChild(doplicateIcon);
